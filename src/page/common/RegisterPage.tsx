...
const RegisterPage: React.FC<PropComponent> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`flex fixed inset-0 transition-all z-20 bg-gray-100/40 ${className}`}
    >
      <div className="m-auto ">
        ...
        >
          ...
          <div className="mt-5 bg-white border border-solid border-gray-200 p-10 rounded-md shadow-sm">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Bằng việc xác nhận, bạn đồng ý với các Điều khoản dịch vụ và Chính
              sách quyền riêng tư của ITviec liên quan đến thông tin riêng tư
              của bạn.
            </p>
          </div>
        </form>
      </div>
      {/* <img src={bg} alt="" className="w-[30%] object-cover" /> */}
    </div>
  );
};
